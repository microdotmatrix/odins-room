...
<svg xmlns="http://www.w3.org/2000/svg" class={$$restProps.class} width="32" height="32" viewBox="0 0 24 24">
  <g stroke={color} stroke-linecap="round" stroke-width="2">
    <path fill={color} fill-opacity="0" stroke-dasharray="34" stroke-dashoffset="34" d="M12 7C14.76 7 17 9.24 17 12C17 14.76 14.76 17 12 17C9.24 17 7 14.76 7 12C7 9.24 9.24 7 12 7">
